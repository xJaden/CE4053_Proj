...
#define  PROBE_COM_CFG_STR_OUT_BUF_SIZE                  128    /* Configure size of string output buf   (see Note #3b).*/
...
#define  PROBE_RS232_CFG_TASK_PRIO                         1    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_RS232_CFG_COMM_SEL         PROBE_RS232_UART_0    /* Configure UART selection (see Note #3).              */
...
#define  PROBE_TCPIP_CFG_TASK_PRIO                        10    /*  Configure parse task priority   (see Note #2a).     */
...
#define  PROBE_USB_CFG_TASK_PRIO                          11    /*  (c) Set task priority.                              */
